...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		{
			case 'spider':
				dialogue = CoolUtil.coolTextFile(Paths.txt('spider/dialogue'));
			case 'timeslip':
				dialogue = CoolUtil.coolTextFile(Paths.txt('timeslip/dialogue'));
			case 'gears-respectively':
				dialogue = CoolUtil.coolTextFile(Paths.txt('gears-respectively/dialogue'));				
			case 'senpai':
		...
		switch(SONG.stage)
		{
			...
			case 'schoolEvil':
			{
					...
					var bg:FlxSprite = new FlxSprite(300, 200).loadGraphic(Paths.image('weeb/BG'));
					bg.antialiasing = true;
